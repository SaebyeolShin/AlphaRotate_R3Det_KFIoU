...
def parse_args():
    ...
    parser.add_argument('--img_dir', dest='img_dir',
                        help='images path',
                        default='/data/dataset_share/HRSC2016/HRSC2016/Test/AllImages', type=str)
    ...
    parser.add_argument('--test_annotation_path', dest='test_annotation_path',
                        ...
                        default='/data/dataset_share/HRSC2016/HRSC2016/Test/xmls', type=str)
    ...
    def eval_with_plac(self, img_dir, det_net, image_ext):
        ...
        with tf.Session(config=config) as sess:
            ...
            for a_img_name in pbar:
                ...
                raw_img = cv2.imread(os.path.join(img_dir,a_img_name))
